...
class ScanAuditRepositoryIT {
    ...
    // @ServiceConnection wires the URL, credentials, and driver from the running
    // container; overriding only spring.datasource.* would leave the H2
    // driver-class-name from application.yml pointing at a PostgreSQL URL.
    @Container
    @ServiceConnection
